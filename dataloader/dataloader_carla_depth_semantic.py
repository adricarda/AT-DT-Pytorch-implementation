...
class SemanticDepth(Dataset):
    ...
    cs = [
        ...
        CityscapesClass('ego vehicle', 1, 19, 'void',
                        0, False, True, (0, 0, 0)),
        CityscapesClass('rectification border', 2, 19,
                        'void', 0, False, True, (0, 0, 0)),
        CityscapesClass('out of roi', 3, 19, 'void',
                        0, False, True, (0, 0, 0)),
        CityscapesClass('static', 4, 19, 'void', 0, False, True, (0, 0, 0)),
        CityscapesClass('dynamic', 5, 19, 'void', 0,
                        False, True, (111, 74, 0)),
        CityscapesClass('ground', 6, 19, 'void', 0, False, True, (81, 0, 81)),
        CityscapesClass('road', 7, 0, 'flat', 1, False, False, (128, 64, 128)),
        CityscapesClass('sidewalk', 8, 1, 'flat', 1,
                        False, False, (244, 35, 232)),
        CityscapesClass('parking', 9, 19, 'flat', 1,
                        False, True, (250, 170, 160)),
        CityscapesClass('rail track', 10, 19, 'flat', 1,
        ...
        CityscapesClass('guard rail', 14, 19, 'construction',
                        2, False, True, (180, 165, 180)),
        CityscapesClass('bridge', 15, 19, 'construction',
                        2, False, True, (150, 100, 100)),
        CityscapesClass('tunnel', 16, 19, 'construction',
                        2, False, True, (150, 120, 90)),
        CityscapesClass('pole', 17, 5, 'object', 3,
                        False, False, (153, 153, 153)),
        CityscapesClass('polegroup', 18, 19, 'object',
        ...
        CityscapesClass('bus', 28, 15, 'vehicle', 7,
                        True, False, (0, 60, 100)),
        CityscapesClass('caravan', 29, 19, 'vehicle',
                        7, True, True, (0, 0, 90)),
        CityscapesClass('trailer', 30, 19, 'vehicle',
                        7, True, True, (0, 0, 110)),
        ...
        CityscapesClass('license plate', -1, 19, 'vehicle',
                        7, False, True, (0, 0, 142)),
    ]

    cs2carla = [
        CityscapesClass('unlabeled',            0,  11,
                        'void', 0, False, True, (0, 0, 0)),
        CityscapesClass('ego vehicle',          1,  11,
                        'void', 0, False, True, (0, 0, 0)),
        CityscapesClass('rectification border', 2,  11,
                        'void', 0, False, True, (0, 0, 0)),
        CityscapesClass('out of roi',           3,  11,
                        'void', 0, False, True, (0, 0, 0)),
        CityscapesClass('static',               4,  11,
                        'void', 0, False, True, (0, 0, 0)),
        CityscapesClass('dynamic',              5,  11,
                        'void', 0, False, True, (111, 74, 0)),
        CityscapesClass('ground',               6,  11,
        ...
        CityscapesClass('parking',              9,  11, 'flat',
                        1, False, True, (250, 170, 160)),
        CityscapesClass('rail track',           10, 11, 'flat',
                        1, False, True, (230, 150, 140)),
        CityscapesClass('building',             11, 9,
                        'construction', 2, False, False, (70, 70, 70)),
        CityscapesClass('wall',                 12, 2,
                        'construction', 2, False, False, (102, 102, 156)),
        CityscapesClass('fence',                13, 3,
                        'construction', 2, False, False, (190, 153, 153)),
        CityscapesClass('guard rail',           14, 11,
                        'construction', 2, False, True, (180, 165, 180)),
        CityscapesClass('bridge',               15, 11,
                        'construction', 2, False, True, (150, 100, 100)),
        CityscapesClass('tunnel',               16, 11,
                        'construction', 2, False, True, (150, 120, 90)),
        CityscapesClass('pole',                 17, 5, 'object',
                        3, False, False, (153, 153, 153)),
        CityscapesClass('polegroup',            18, 11,
                        'object', 3, False, True, (153, 153, 153)),
        CityscapesClass('traffic light',        19, 8, 'object',
                        3, False, False, (250, 170, 30)),
        CityscapesClass('traffic sign',         20, 8,
                        'object', 3, False, False, (220, 220, 0)),
        CityscapesClass('vegetation',           21, 6, 'nature',
                        4, False, False, (107, 142, 35)),
        CityscapesClass('terrain',              22, 11,
                        'nature', 4, False, False, (152, 251, 152)),
        CityscapesClass('sky',                  23, 10, 'sky',
                        5, False, False, (70, 130, 180)),
        CityscapesClass('person',               24, 4, 'human',
                        6, True, False, (220, 20, 60)),
        CityscapesClass('rider',                25, 11,
                        'human', 6, True, False, (255, 0, 0)),
        CityscapesClass('car',                  26, 7,
                        'vehicle', 7, True, False, (0, 0, 142)),
        CityscapesClass('truck',                27, 11,
                        'vehicle', 7, True, False, (0, 0, 70)),
        CityscapesClass('bus',                  28, 11,
                        'vehicle', 7, True, False, (0, 60, 100)),
        CityscapesClass('caravan',              29, 11,
                        'vehicle', 7, True, True, (0, 0, 90)),
        CityscapesClass('trailer',              30, 11,
                        'vehicle', 7, True, True, (0, 0, 110)),
        CityscapesClass('train',                31, 11,
                        'vehicle', 7, True, False, (0, 80, 100)),
        CityscapesClass('motorcycle',           32, 7,
                        'vehicle', 7, True, False, (0, 0, 230)),
        CityscapesClass('bicycle',              33, 11,
                        'vehicle', 7, True, False, (119, 11, 32)),
        CityscapesClass('license plate',        -1, 11,
                        'vehicle', 7, False, True, (0, 0, 142)),
    ]

    carla = [
        #       name                                id    trainId   category            catId     hasInstances   ignoreInEval   color
        CityscapesClass('road',    0,       0, 'flat',
                        1, False, False, (128, 64, 128)),
        CityscapesClass('sidewalk',    1,       1, 'flat',
                        1, False, False, (244, 35, 232)),
        CityscapesClass('building',    9,       9,
                        'construction', 2, False, False, (70, 70, 70)),
        CityscapesClass('wall',    2,       2, 'construction',
                        2, False, False, (102, 102, 156)),
        CityscapesClass('fence',    3,       3, 'construction',
                        2, False, False, (190, 153, 153)),
        CityscapesClass('pole',    5,       5, 'object',
                        3, False, False, (153, 153, 153)),
        CityscapesClass('traffic light',    8,       8,
                        'object', 3, False, False, (250, 170, 30)),
        CityscapesClass('traffic sign',    8,       8, 'object',
                        3, False, False, (220, 220,  0)),
        CityscapesClass('vegetation',    6,       6, 'nature',
                        4, False, False, (107, 142, 35)),
        CityscapesClass('terrain',  255,      11, 'nature',
                        4, False, False, (0, 0, 0)),
        CityscapesClass('sky',   10,      10, 'sky', 5,
                        False, False, (70, 130, 180)),
        CityscapesClass('person',    4,       4, 'human',
                        6, True, False, (220, 20, 60)),
        CityscapesClass('rider',  255,      11, 'human',
                        6, True, False, (0,  0,  0)),
        CityscapesClass('car',    7,       7, 'vehicle',
                        7, True, False, (0,  0, 142)),
        CityscapesClass('truck',  255,      11, 'vehicle',
                        7, True, False, (0,  0, 0)),
        CityscapesClass('bus',  255,      11, 'vehicle',
                        7, True, False, (0, 0, 0)),
        CityscapesClass('train',  255,      11, 'vehicle',
                        7, True, False, (0, 0, 0)),
        CityscapesClass('motorcycle',    7,       7, 'vehicle',
                        7, True, False, (0, 0, 230)),
        CityscapesClass('bicycle',  255,      11, 'vehicle',
                        7, True, False, (0, 0, 0)),
    ]
    ...
    def get_predictions_plot(self, batch_sample, predictions_semantic, batch_gt_semantic, predictions_depth, batch_gt_depth):
        ...
        for image, prediction_semantic, gt_semantic, prediction_depth, gt_depth, (axis1, axis2, axis3, axis4, axis5) in \
            ...
            gt_semantic = self.colorize_mask(
                gt_semantic, encode_with_train_id=True)
