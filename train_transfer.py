...
def train_epoch(model_source, model_target, transfer, 
                ...
                loss_fn1, loss_fn2, opt1=None, opt2=None, opt3=None, lr_scheduler=None, metrics=None, params=None):
...
def train_and_evaluate(model_source, model_target, transfer, train_dl_all, train_dl_depth_target, val_dl_source_all, val_dl_target, 
    ...
    for epoch in range(start_epoch, params.num_epochs):
        ...
        transfer.train()
        train_loss, train_metrics = train_epoch(model_source, model_target, transfer, 
                                                train_dl_all, train_dl_depth_target, val_dl_source_all, val_dl_target, 
                                                opt1, opt2, opt3, loss_fn1, loss_fn2,
                                                lr_scheduler1, lr_scheduler2, lr_scheduler3, params=params)
...
if __name__ == '__main__':
    ...
    loss_fn1 = get_loss_fn(params_transfer)
    loss_fn2 = get_loss_fn(params_source)
